 ...
 */
public class VerifierOrchestratorPerf extends VerifierOrchestrator {
	...
	public VerifierOrchestratorPerf(ExtendedPublicKey extendedPublicKey, IMessageGateway messageGateway) {
